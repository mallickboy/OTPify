...
from app.api.v1.endpoint import auth_endpoint, otp_endpoint, report_endpoint, user_endpoint, email_endpoint
...
api_router.include_router(email_endpoint.router, prefix="/email", tags=["Email"])
